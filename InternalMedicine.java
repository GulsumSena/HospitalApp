...
public class InternalMedicine extends Doctor{
	
	private static int available=1;
	private static int day=15;
	public InternalMedicine (String name, String branche) {
		super(name, branche);
	}
	...
	public void addInternal() {
		...
		System.out.println();
		System.out.println("DAHİLİYE");
		System.out.println("BOŞ KADRO SAYISI: "+available);
		System.out.println();
		
			if(super.getBranche().equalsIgnoreCase("dahiliye")||super.getBranche().equalsIgnoreCase("iç hastalıkları")) {
				if(available>=1) {
					...
					System.out.println("DAHİLİYE KADROLARI DOLU");
					System.out.println();
					System.out.println("-------------------------------");
				}
